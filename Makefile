.PHONY: help test check require-base-rpc anvil-base test-integration update-aave-manifest
...
help:
	...
	@printf "  make update-aave-manifest  Regenerate the Base Aave deployment manifest\n"
